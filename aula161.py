...
# Exercícios
# Aumento os preços dos produtos a seguir 10%
...
# Gere produtos_ordenados_por_nome por deep cop (cópia profunda)
...
# Gere produtos_ordenados_por_preco por deep cop (cópia profunda)
